...
public class ApiConnector {
    ...
    public JSONArray sendCurrentPosition(String latitude,String longitude, String id)
    {
        // URL for getting all customers

        //192.168.0.4
        String url = "http://seproject.site11.com/seProject/ShortestDistance.php?longitude="+longitude+"&latitude="+latitude+"&id="+id;
